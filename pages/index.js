    ...
    <Layout>
      <PageSection color="#37609c">
        <PageWrapper>
          <article>
            <h1
              data-text="I'm Muhammadrizo Bakhtiyorov"
              className="intro__text"
            >
              <mark className="mark">I&apos;m Muhammadrizo Bakhtiyorov</mark>
            </h1>
            <p>
              {' '}
              Frontend developer, practicing minimalist and Figma designer by
              day.
            </p>
            <p>
              ...
              >
                baxtiyorovmuhammadrizo@gmail.com
              </button>
              .
            </p>
          </article>
